...
// import { ShopDetailScreenProps } from '../../../navigation/customer-navigator/customerAllProduct.navigator';
...
// export class ShopDetailScreen extends React.Component<ShopDetailScreenProps & OffersDetailScreenProps & ThemedComponentProps, MyState & any> {
//     constructor(props) {
//         super(props)
//         this.state = {
...
//                 },
//                 {
//                     url: '/api/useraddress/getbyuserid/' + this.props.route.params.adminId,
//                     method: 'GET',
...
//                     const image1 = []
//                     response.data[0].shopImage.map((shopImage) => {
//                         image1.push(AppConstants.IMAGE_BASE_URL + '/shop/' + shopImage.avatarName)
//                     })
...
//     render() {
//         const { isSelectedWish, allCategory, userData, productQuantity, allMeasurement, allImages, wishList, allProduct, productId } = this.state
//         return (
//             <SafeAreaLayout
...
//                                     <Text style={{ color: '#000', paddingVertical: 20, fontWeight: 'bold', fontSize: 20 }}>{allProduct.shopName}</Text>
//                                     {null != allCategory ? allCategory.map((shopType, sIndex) => {
//                                         if (allProduct.shopType == shopType.lookUpId) {
//                                             return (
//                                                 <Text style={{ color: '#000', marginTop: -20, paddingVertical: 20, fontWeight: 'bold', fontSize: 20 }}>{allProduct.quantity} {shopType.lookUpName}</Text>
//                                             );
//                                         }
//                                     }) : null}
